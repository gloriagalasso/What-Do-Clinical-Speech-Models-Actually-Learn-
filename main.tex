...
\captionof{figure}{CBM vs.\ CEM: binary nodes vs.\ embedding pairs.
Note: text serves opposite roles --- offline label generator (Ghia et al.)
vs.\ live multimodal input (Leschly et al.)\cite{ghia2025conceptbasedapproachvoicedisorder, 1e0730b6d8ef423d89d5860c23834a1b}.}
\end{center}
\vspace{1cm}
...
\begin{center}
\includegraphics[width=0.75\linewidth]{figures/neuroxvocal.png}
