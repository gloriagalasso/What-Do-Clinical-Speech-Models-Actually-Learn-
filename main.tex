...
\begin{tabular}{|l|r|r|}
\hline
\textbf{Task} & \textbf{Black-box} & \textbf{Explainable} \\ \hline
Voice disorder & \textbf{91.3\%} & 87.8\% \\ \hline
Dysarthria & 82.5\% & \textbf{83.9\%} \\ \hline
Alzheimer's & $<$95.8\% & \textbf{95.8\% (SOTA)} \\ \hline
\end{tabular}
\captionof{table}{Performance comparison of black-box and explainable models across clinical speech tasks\cite{ghia2025conceptbasedapproachvoicedisorder,xu2023dysarthria,Ntampakis_2025}.}
\end{center}
...
\colorbox{yellow!10}{%
  \parbox{\dimexpr\linewidth-2\fboxsep}{%
    \LARGE
    \textbf{\color{Black}Key Finding:} Interpretability does not necessarily come at the cost of accuracy. Concept-based models often match or exceed black-box performance while providing transparent clinical reasoning.
  }%
}
\vspace{1cm}
...
\vfill
\hfill\includegraphics[width=4cm]{figures/references_qr.png}
